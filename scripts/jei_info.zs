...
Jei.hideIngredientsByRegex(".*furnace_boat");
Jei.hideIngredientsByRegex(".*large_.*_boat");

Jei.hideIngredientsByRegex(".*spawn_egg.*");

Jei.hideIngredientsByRegex("upgrade_aquatic:.*leaf_pile");
Jei.hideIngredientsByRegex("autumnity:.*leaf_pile");
Jei.hideIngredientsByRegex("environmental:.*leaf_pile");
Jei.hideIngredientsByRegex("atmospheric:.*leaf_pile");

i(<item:environmental:truffle>, "Feed a pig a golden carrot, and it will lead you to a buried truffle block.");

// Pet Cemetery
i(<item:pet_cemetery:pet_collar>, "Right-clicking a charged respawn anchor with a pet collar will respawn your pet as a (curable) zombie version of themselves.");
...
i(<item:alexsmobs:shark_tooth>, s);
...
i(<item:overweight_farming:straw_hat>, "Only sold by Farmers. Increases crop growth speed around you when worn.");
i(<item:waystones:waystone>, "Can only be found in Villages, Battle Towers, and Towers of the Wild. Cannot be crafted and will not drop when broken.");
...
// World Stones
i(<item:quark:jasper>, "This spawns in large clusters under Badlands and Deserts. It also generates when flowing Lava touches hydrated Cracked Mud.");
i(<item:quark:limestone>, "This spawns in large clusters under Swamps and Oceans. It also generates when flowing Lava touches Honey.");
i(<item:minecraft:calcite>, "This spawns in large clusters under Moutanins. It also generates when flowing Lava touches a Magma Block and Blue Ice at the same time, with an upwards-facing Bone Block below.");
...
i(<item:quark:shale>, "This spawns in large clusters under icy and snowy biomes. It also generates when flowing Lava touches Permafrost.");
...
i(<item:minecraft:chain>, "Can be connected to fences and walls.");
...
i(<item:domesticationinnovation:collar_tag>, "Can be enchanted and put on pets to enable new abilities.");
i(<item:domesticationinnovation:drum>, "Applying a redstone signal will order all tamed mobs of the user to stay, wander, or follow, depending on the selected mode.");


i(<item:paraglider:paraglider>, "Can be found in Wild Tower chests only. When held, right click to glide.");
...
i(<item:environmental:white_wisteria_hedge>, s);
i(<item:environmental:pink_wisteria_hedge>, s);
i(<item:environmental:purple_wisteria_hedge>, s);
i(<item:environmental:blue_wisteria_hedge>, s);
i(<item:environmental:cherry_hedge>, s);
...
s = "Leaf piles will build up after a tree is cut down.";
...
i(<item:immersive_weathering:quark/ancient_leaf_pile>, s);
i(<item:immersive_weathering:upgrade_aquatic/river_leaf_pile>, s);
i(<item:immersive_weathering:autumnity/maple_leaf_pile>, s);
i(<item:immersive_weathering:autumnity/red_maple_leaf_pile>, s);
i(<item:immersive_weathering:autumnity/yellow_maple_leaf_pile>, s);
i(<item:immersive_weathering:autumnity/orange_maple_leaf_pile>, s);
i(<item:immersive_weathering:atmospheric/rosewood_leaf_pile>, s);
i(<item:immersive_weathering:atmospheric/morado_leaf_pile>, s);
i(<item:immersive_weathering:atmospheric/yucca_leaf_pile>, s);
i(<item:immersive_weathering:atmospheric/aspen_leaf_pile>, s);
i(<item:immersive_weathering:atmospheric/flowering_morado_leaf_pile>, s);
i(<item:immersive_weathering:environmental/cherry_leaf_pile>, s);
i(<item:immersive_weathering:oak_leaf_pile>, s);
i(<item:immersive_weathering:mangrove_leaf_pile>, s);
...
i(<item:ecologics:azalea_flower>, "Obtained by shearing flowering azalea and its leaves.");
...
i(<item:overweight_farming:overweight_nether_wart_block>, s);
i(<item:overweight_farming:overweight_potato_block>, s);
i(<item:overweight_farming:overweight_onion_block>, s);
i(<item:overweight_farming:overweight_apple_block>, s);
i(<item:overweight_farming:overweight_golden_apple_block>, s);
i(<item:overweight_farming:overweight_cabbage_block>, s);
i(<item:overweight_farming:overweight_ginger_block>, s);
...
// Generators
i(<item:minecraft:diorite>, "Generates when Water touches flowing Lava adjacent to Smooth Quartz.");
i(<item:minecraft:granite>, "Generates when Water touches flowing Lava adjacent to Smooth Quartz and Diorite.");
i(<item:minecraft:crying_obsidian>, "Generates when Water touches a Lava source block with adjacent Soul Fire.");
i(<item:minecraft:blackstone>, "Generates when flowing Lava touches a Magma Block and Blue Ice at the same time.");
i(<item:minecraft:smooth_basalt>, "Generates when Water touches flowing Lava adjacent to Blue Ice with Soul Soil below.");
i(<item:minecraft:magma_block>, "Generates when a bubble column touches a Lava source block.");
i(<item:minecraft:terracotta>, "Generates when Lava touches Clay Blocks.");
i(<item:immersive_weathering:vitrified_sand>, "Generates when Sand is struck by lightning. Also generates when Lava touches Sand.");
