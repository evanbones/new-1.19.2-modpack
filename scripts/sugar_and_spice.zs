...
craftingTable.removeByRegex(".*machete.*");
craftingTable.removeByRegex("immersive_weathering:.*snow_brick.*");
stoneCutter.removeByRegex("immersive_weathering:.*snow_brick.*");
craftingTable.removeByRegex("ecologics:.*snow.*");
stoneCutter.removeByRegex("ecologics:.*snow.*");
craftingTable.removeByRegex("create:.*glass.*");
stoneCutter.removeByRegex("create:.*glass.*");

furnace.removeByRegex("architects_palette:.*basalt.*");
stoneCutter.removeByRegex("architects_palette:.*basalt.*");
craftingTable.removeByRegex("architects_palette:.*basalt.*");
craftingTable.removeByRegex(".*:.*kousa.*");
craftingTable.removeByRegex(".*:.*grimwood.*");
furnace.removeByRegex("architects_palette:.*heavy.*");
stoneCutter.removeByRegex("architects_palette:.*heavy.*");
craftingTable.removeByRegex("architects_palette:.*heavy.*");
furnace.removeByRegex("architects_palette:.*brass.*");
stoneCutter.removeByRegex("architects_palette:.*brass.*");
stoneCutter.removeByRegex("create:.*small_.*brick.*");
craftingTable.removeByRegex("architects_palette:.*brass.*");	
...
stoneCutter.remove(<item:architects_palette:calcite_bricks>);
craftingTable.remove(<item:architects_palette:calcite_pillar>);
stoneCutter.remove(<item:architects_palette:calcite_pillar>);
craftingTable.remove(<item:architects_palette:calcite_brick_vertical_slab>);
stoneCutter.remove(<item:architects_palette:calcite_brick_vertical_slab>);
craftingTable.remove(<item:architects_palette:calcite_brick_stairs>);
stoneCutter.remove(<item:architects_palette:calcite_brick_stairs>);
craftingTable.remove(<item:architects_palette:calcite_brick_slab>);
stoneCutter.remove(<item:architects_palette:calcite_brick_slab>);
craftingTable.remove(<item:architects_palette:chiseled_calcite>);
stoneCutter.remove(<item:architects_palette:chiseled_calcite>);
craftingTable.remove(<item:architects_palette:calcite_brick_wall>);
stoneCutter.remove(<item:architects_palette:calcite_brick_wall>);

craftingTable.remove(<item:architects_palette:dripstone_bricks>);
stoneCutter.remove(<item:architects_palette:dripstone_bricks>);
craftingTable.remove(<item:architects_palette:dripstone_pillar>);
stoneCutter.remove(<item:architects_palette:dripstone_pillar>);
craftingTable.remove(<item:architects_palette:dripstone_brick_vertical_slab>);
stoneCutter.remove(<item:architects_palette:dripstone_brick_vertical_slab>);
craftingTable.remove(<item:architects_palette:dripstone_brick_stairs>);
stoneCutter.remove(<item:architects_palette:dripstone_brick_stairs>);
craftingTable.remove(<item:architects_palette:dripstone_brick_slab>);
stoneCutter.remove(<item:architects_palette:dripstone_brick_slab>);
craftingTable.remove(<item:architects_palette:chiseled_dripstone>);
stoneCutter.remove(<item:architects_palette:chiseled_dripstone>);
craftingTable.remove(<item:architects_palette:dripstone_brick_wall>);
stoneCutter.remove(<item:architects_palette:dripstone_brick_wall>);

craftingTable.remove(<item:architects_palette:tuff_bricks>);
stoneCutter.remove(<item:architects_palette:tuff_bricks>);
craftingTable.remove(<item:architects_palette:tuff_pillar>);
stoneCutter.remove(<item:architects_palette:tuff_pillar>);
craftingTable.remove(<item:everycomp:ap/biomemakeover/willow_railing>);
craftingTable.remove(<item:architects_palette:tuff_brick_vertical_slab>);
stoneCutter.remove(<item:architects_palette:tuff_brick_vertical_slab>);
craftingTable.remove(<item:architects_palette:tuff_brick_stairs>);
stoneCutter.remove(<item:architects_palette:tuff_brick_stairs>);
craftingTable.remove(<item:architects_palette:tuff_brick_slab>);
stoneCutter.remove(<item:architects_palette:tuff_brick_slab>);
craftingTable.remove(<item:architects_palette:chiseled_tuff>);
stoneCutter.remove(<item:architects_palette:chiseled_tuff>);
craftingTable.remove(<item:architects_palette:tuff_brick_wall>);
stoneCutter.remove(<item:architects_palette:tuff_brick_wall>);
...
craftingTable.remove(<item:immersive_weathering:permafrost>);
craftingTable.remove(<item:immersive_weathering:fluvisol>);
craftingTable.remove(<item:immersive_weathering:vertisol>);
craftingTable.remove(<item:immersive_weathering:humus>);
craftingTable.remove(<item:immersive_weathering:cryosol>);
craftingTable.remove(<item:immersive_weathering:thin_ice>);
...
<recipetype:create:milling>.remove(<item:create:crushed_raw_zinc>);
...
<recipetype:create:mixing>.addRecipe("crimsite_mixing", <constant:create:heat_condition:none>, [<item:create:cut_crimsite> * 1], [<item:minecraft:stone>, <item:minecraft:redstone>]);
<recipetype:create:mixing>.addRecipe("asurine_mixing", <constant:create:heat_condition:none>, [<item:create:cut_asurine> * 1], [<item:minecraft:stone>, <item:minecraft:lapis_lazuli>]);
...
<recipetype:create:mixing>.addRecipe("veridium_mixing", <constant:create:heat_condition:none>, [<item:create:cut_veridium> * 1], [<item:minecraft:stone>, <item:architects_palette:algal_blend>]);
...
craftingTable.remove(<item:immersive_weathering:flower_crown>);
craftingTable.addShaped("flower_crown_eco", <item:immersive_weathering:flower_crown>, [
	[<item:ecologics:azalea_flower>, <item:ecologics:azalea_flower>, <item:ecologics:azalea_flower>],
	[<item:ecologics:azalea_flower>, <item:minecraft:air>, <item:ecologics:azalea_flower>],
	[<item:ecologics:azalea_flower>, <item:ecologics:azalea_flower>, <item:ecologics:azalea_flower>]
]);

villagerTrades.removeWanderingTrade(1, <item:alexsmobs:banana_peel>);
villagerTrades.removeWanderingTrade(2, <item:alexsmobs:banana_peel>);
villagerTrades.removeWanderingTrade(1, <item:alexsmobs:blood_sac>);
villagerTrades.removeWanderingTrade(2, <item:alexsmobs:blood_sac>);
villagerTrades.removeWanderingTrade(1, <item:supplementaries:flax_seeds>);



// Food and Drinks ================================================================================
craftingTable.remove(<item:autumnity:pancake>);
<recipetype:create:compacting>.remove(<item:autumnity:pancake>);
<recipetype:create:compacting>.remove(<item:create:bar_of_chocolate>);
<recipetype:create:compacting>.addRecipe("wheat_pancake", <constant:create:heat_condition:none>, [<item:supplementaries:pancake>], [<item:autumnity:syrup_bottle>, <item:minecraft:egg>, <item:minecraft:wheat> * 2], [<fluid:minecraft:milk> * 250]);
<recipetype:create:compacting>.addRecipe("flour_pancake", <constant:create:heat_condition:none>, [<item:supplementaries:pancake>], [<item:autumnity:syrup_bottle>, <item:minecraft:egg>, <item:create:wheat_flour> * 2], [<fluid:minecraft:milk> * 250]);
...
<recipetype:create:mixing>.addRecipe("neapolitan_chocolate", <constant:create:heat_condition:none>, [<fluid:create:chocolate> * 250], [<item:minecraft:sugar>, <item:minecraft:cocoa_beans> * 2], [<fluid:minecraft:milk> * 250]);
<recipetype:create:mixing>.addRecipe("vanilla_fudge", <constant:create:heat_condition:none>, [<item:neapolitan:vanilla_fudge> * 4], [<item:minecraft:sugar>, <item:neapolitan:dried_vanilla_pods> * 2], [<fluid:minecraft:milk> * 250]);
...
craftingTable.remove(<item:minecraft:moss_block>);
craftingTable.remove(<item:ecologics:surface_moss>);
craftingTable.remove(<item:supplementaries:doormat>);
craftingTable.addShapeless("coconut_bowls", 
		<item:minecraft:bowl>, 
		[<item:ecologics:coconut_husk>]);
craftingTable.addShapeless("mossy_cobblestone_bricks_mc", 
		<item:quark:mossy_cobblestone_bricks>, 
		[<item:quark:cobblestone_bricks>, <item:minecraft:vine>]);
craftingTable.addShapeless("mossy_cobblestone_bricks_mc2", 
		<item:quark:mossy_cobblestone_bricks>, 
		[<item:quark:cobblestone_bricks>, <item:minecraft:moss_block>]);
craftingTable.addShapeless("mossy_cobblestone_bricks_iw", 
		<item:quark:mossy_cobblestone_bricks>, 
		[<item:quark:cobblestone_bricks>, <item:immersive_weathering:moss_clump>]);
...
craftingTable.removeByRegex("autumnity:.*leaf_pile");
craftingTable.removeByRegex("atmospheric:.*leaf_pile");
craftingTable.removeByRegex(".*truffle_pie.*");
craftingTable.removeByRegex("environmental:.*leaf_pile");
...
craftingTable.addShaped("a_bricks", <item:create:cut_asurine_bricks>, [
	[<item:create:cut_asurine>, <item:create:cut_asurine>],
	[<item:create:cut_asurine>, <item:create:cut_asurine>]
]);

craftingTable.addShaped("b_bricks", <item:create:cut_crimsite_bricks>, [
	[<item:create:cut_crimsite>, <item:create:cut_crimsite>],
	[<item:create:cut_crimsite>, <item:create:cut_crimsite>]
]);

craftingTable.addShaped("c_bricks", <item:create:cut_ochrum_bricks>, [
	[<item:create:cut_ochrum>, <item:create:cut_ochrum>],
	[<item:create:cut_ochrum>, <item:create:cut_ochrum>]
]);

craftingTable.addShaped("d_bricks", <item:create:cut_veridium_bricks>, [
	[<item:create:cut_veridium>, <item:create:cut_veridium>],
	[<item:create:cut_veridium>, <item:create:cut_veridium>]
]);

craftingTable.addShaped("e_bricks", <item:create:cut_scorchia_bricks>, [
	[<item:create:cut_scorchia>, <item:create:cut_scorchia>],
	[<item:create:cut_scorchia>, <item:create:cut_scorchia>]
]);

craftingTable.addShaped("f_bricks", <item:create:cut_scoria_bricks>, [
